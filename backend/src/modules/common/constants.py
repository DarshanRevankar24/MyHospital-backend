...
EXCEPTION_MAPPING: dict[type[DomainError], Callable[[str], HTTPException]] = {
    ...
    ResourceExistsError: lambda message: HTTPException(status_code=409, detail=message or "This resource already exists."),
    ...
    UserExistsError: lambda message: HTTPException(
        status_code=409,
