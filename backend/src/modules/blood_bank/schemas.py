...
class BloodBankProviderRead(BaseModel):
    ...
    id: int; name: str; license_number: str; address_line1: str
    address_line2: str | None = None; city: str; state: str; pincode: str
    phone: str; email: str | None = None; is_24x7: bool; is_verified: bool
...
class BloodBankProviderCreate(BaseModel):
    ...
    email: str | None = None; is_24x7: bool = False


class BloodStockRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
    id: int; provider_id: int; blood_group: str; units_available: int
...
class BloodRequestRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
    id: int; request_ref: str; user_id: int; provider_id: int
    blood_group: str; units_required: int; urgency: str
    patient_name: str; patient_hospital: str | None = None
    patient_contact: str; required_by_date: str | None = None
    status: BloodRequestStatus; notes: str | None = None
